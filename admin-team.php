          ...
          <div class="info" style="margin-left: 150px;">
            ...
            <ul class="navbar-nav col-lg-6 justify-content-lg-center">
              ...
              >
                ...
                <li class="nav-icon">
                    <a href="admin-events.php" class="nav-link text-dark">
                      <svg class="bi d-block mx-auto mb-1" width="30" height="30">
                      ...
                      <li class="nav-icon">
                        <a href="admin-booking.php" class="nav-link text-black">
                          <svg class="bi d-block mx-auto mb-1" width="30" height="30">
                    ...
                    <li class="nav-icon">
                      <a href="admin-user.php" class="nav-link text-black">
                        <svg class="bi d-block mx-auto mb-1" width="30" height="30">
                            <use xlink:href="#user" />
                          </svg>
                         user
                    ...
                    <li class="nav-icon">
                        <a href="admin-tournament.php" class="nav-link text-black">
                          <svg class="bi d-block mx-auto mb-1" width="30" height="30">
                      ...
                      <li class="nav-icon">
                        <a href="admin-team.php" class="nav-link text-black">
                          <svg class="bi d-block mx-auto mb-1" width="30" height="30">
                              <use xlink:href="#team" />
                            </svg>
                            teams
                    ...
                    <li class="nav-icon">
                        <a href="admin-stadium.php" class="nav-link text-black">
                          <svg class="bi d-block mx-auto mb-1" width="30" height="30">
                              <use xlink:href="#stadium" />
                            </svg>
                            stadiums
                        </a>
                      </li>
...
<button class="button button-black width-auto  book-ticket-btn" style="margin : 1px; margin-top: 1%;"  id="addNewmatchButton" type="submit"  name="add">Add new team</button></div>
        <h5 style="font-weight : bold; margin: 1%;" for="myDropdown">Select team </h5>
        <div>
        ...
        <?php
            ...
            while ($row = $result->fetch_assoc()) {
                $team_id = $row['team_id'];
                $name = $row['team_name'];
                echo "<option value='$team_id' " . ($selectedOption == "$team_id" ? 'selected' : '') . ">$team_id - $name</option>";
            }
            ?>
        </select>
    </form>
  ...
  $sqlData = "SELECT * FROM $table_name WHERE team_id LIKE '%$selectedOption%'";
  ...
  if ($selectedOption!="") {
    ...
    <input class="form-control" id="' . $inputId . '" type="text" placeholder="' . $columnData . '" value="' . $columnData . '"  name="' . $columnName . '_id" readonly>';
      ...
      <div class="d-flex justify-content-end">
      <input type="hidden" name="team_id" value='.$selectedOption.'>
...
if (isset($_POST['save'])) {
  $teamIdToEdit= $_POST['team_id'];
  $name= $_POST['team_name_id'];
  $url= $_POST['team_logo_url_id'];
  
// Update the match data in the database
$sqlUpdate = "UPDATE team
SET team_name = '$name',
team_logo_url = '$url'
WHERE team_id = '$teamIdToEdit'";
  ...
  if ($resultUpdate) {
      ...
      echo '<script>window.location.href = "admin-team.php";</script>';
  } else {
      // Update failed
    ...
    elseif (isset($_POST['delete']) ) {
        ...
        $teamIdToDelete= $_POST['team_id'];
          ...
          $sqlDelete = "DELETE FROM $table_name WHERE team_id = '$teamIdToDelete'";
     ...
     if (isset($_POST['add'])) {
      echo '<script>window.location.href = "admin-add-team.php";</script>';
  } 
    }
