...
$sql = "SELECT booking.booking_id, booking.user_id, users.username
FROM booking
...
<div class="px-3 py-2 text-bg-dark border-bottom">
      ...
      <nav class="navbar navbar-expand-lg bg-body-tertiary rounded" aria-label="Thirteenth navbar example">
        <div class="container-fluid">
          ...
          <img class="rounded-circle" style="width: 100px; height: 100px; object-fit: cover; margin-right: 20px; margin-left: 80px;" src="https://scontent.fcai19-3.fna.fbcdn.net/v/t39.30808-6/328553536_723427136242630_2529008484029571012_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=efb6e6&_nc_ohc=Md__HbQ-fiMAX-WiuTB&_nc_ht=scontent.fcai19-3.fna&oh=00_AfAi8d9a22DNbR_qpFg9C6drysmpHA-krrEUoc47ZY7rqA&oe=6597C72A">
            <div class="info">
    ...
    <li class="nav-item">
    <button id="button1" class="btn btn-dark" onclick="redirectToPage('admin-booking.php', this)" disabled>Matches</button>
<button id="button2" class="btn btn-dark" onclick="redirectToPage('admin-booking-events.php', this)">Events</button>
...
if (isset($_POST['save'])) {
  ...
  $match = ($_POST['match_id_id']);
  $ticketcat=($_POST['ticket_category_id_id']);
