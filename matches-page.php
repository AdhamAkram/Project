      ...
      <div class="modal-content">
          ...
          <div class="mt-3">
              ...
              <select id="cat-select" class="cat-select">
                ...
                // foreach ($ticketCategories as $category) {
                //     echo '<option id="selectedCat" ';
                //    if(isset($_POST['selectedCat']) && $_POST['selectedCat'] == $category) {
                //        echo 'selected';
                //     }
                //       echo ' value="' . $category['category_name'] . '">' . $category['category_name'] . ' - ' . $category['price'] . 'EGP</option>';
                //   }
