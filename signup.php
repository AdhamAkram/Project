...
<body>
    <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
        ...
        <symbol id="profile" viewBox="0 0 16 16">
            ...
            <path fill-rule="evenodd" d="M4.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H14.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3z"/>        </symbol>
    ...
    <div class="px-3 py-2 text-bg-dark border-bottom">
      <div class="container">
        ...
        <a
          ...
          >
         <img class="icon" src="2.svg" width="55" height="55" style="margin-top:15px" alt="Your SVG Image">
       </a>
          ...
          >
            ...
            <li>
                <a href="signin-form.php" class="nav-link text-white">
